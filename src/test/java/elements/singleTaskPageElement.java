...
public class singleTaskPageElement {
    ...
    public static SelenideElement issueTypeBug = $x ("(//div[@class='aui-list-scroll'])[3]//li[contains(@id,'ошибка')]");
    ...
    public static SelenideElement priorityFieldMedium = $x ("//div[@id='priority-suggestions']//li[contains(@id,'medium')]");
